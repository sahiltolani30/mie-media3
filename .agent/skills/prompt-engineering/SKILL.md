...
Usefull for writing prompts, including but not limited to: commands, hooks, skills, or prompts for sub agents or any other LLM interaction.
...
```markdown
✅ Checklists without proper tracking = steps get skipped. Every time.
